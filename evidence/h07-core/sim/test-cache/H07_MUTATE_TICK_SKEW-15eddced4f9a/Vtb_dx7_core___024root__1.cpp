...
void Vtb_dx7_core___024root___nba_sequent__TOP__2(Vtb_dx7_core___024root* vlSelf) {
    ...
    vlSelfRef.tb_dx7_core__DOT__dut__DOT__evq_peek_empty_d 
        = ((0U == (IData)(vlSelfRef.tb_dx7_core__DOT__dut__DOT__evq_cnt)) 
           | (0U != (IData)(vlSelfRef.tb_dx7_core__DOT__dut__DOT__skid_cnt)));
