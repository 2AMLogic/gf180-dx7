...
| Mapped area vs H02's 38,781-flop accounting + strip-obs gate | **PASS** — 138,490 mapped flops (> 38,781), 36,803 cells, chip area 1,158,154.6 µm², sequential 473,572.7 µm² (`synth_report.json`); strip-obs control maps 0 flops — gate fails as required |
